...
database_org=pd.read_csv("Database\\ml-100k\\ua.base",sep="\t").as_matrix()
datatest_org=pd.read_csv("Database\\ml-100k\\ua.test",sep="\t").as_matrix()
...
CF.display_recommentdation([0,1,2,3,4,5,6],n_recomment=5)
